...
const NeonButton = ({
  ...
  const variants = {
    primary:
      "bg-accent text-black hover:bg-white hover:shadow-[0_0_30px_rgba(255,230,0,0.6)]",
    outline:
      "bg-transparent border border-accent text-accent hover:bg-accent hover:text-black hover:shadow-[0_0_20px_rgba(255,230,0,0.4)]",
