        ...
        <div className="container mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
            <div className="relative">
              ...
              <div className="relative z-10 aspect-[3/4] overflow-hidden grayscale transition-all duration-700">
                <img src={alexPortrait} alt="Alex Bogeas" className="w-full h-full object-cover opacity-70" />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 h-[600px] md:h-[400px]">
          {[seminarStage, fadeCloseup, masterclassCrowd, luxuryWorkspace].map((img, idx) => (
            <div key={idx} className="relative group overflow-hidden h-full">
              <img src={img} alt={`Showcase ${idx}`} className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110 filter grayscale opacity-60 group-hover:opacity-80" />
